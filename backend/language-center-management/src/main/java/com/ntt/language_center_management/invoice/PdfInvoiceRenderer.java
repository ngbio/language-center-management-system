...
public final class PdfInvoiceRenderer implements InvoiceRenderer {
  private static final float MARGIN = 48;
  private static final float LINE_HEIGHT = 18;
  private final String fontPath;

  public PdfInvoiceRenderer(String fontPath) { this.fontPath = fontPath; }
  ...
  public ExportedDocument render(InvoiceResponse invoice) {
    try (PDDocument document = new PDDocument();
      ...
      try (PageWriter writer = new PageWriter(document, font)) {
        ...
        return new ExportedDocument(output.toByteArray(), "application/pdf",
            "invoice-enrollment-" + invoice.enrollmentId() + ".pdf");
      }
  ...
  private InputStream resolveFontStream() throws IOException {
    ...
    InputStream bundledFont = PdfInvoiceRenderer.class
