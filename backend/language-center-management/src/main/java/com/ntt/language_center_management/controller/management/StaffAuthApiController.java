...
public class StaffAuthApiController {

  private final UserService userService;
  private final JwtUtils jwtUtils;

  public StaffAuthApiController(UserService userService, JwtUtils jwtUtils) {
  ...
  public ResponseEntity<ApiResponse<LoginResponse>> login(
    ...
    UserResponse user = userService.loginStaff(request);
    ...
    return ResponseEntity.ok(
        new ApiResponse<>(HttpStatus.OK.value(), "Đăng nhập nhân viên thành công", response));
  }
}
